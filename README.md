...
![Agent Qt 首页](docs/images/agent-qt-home.png)
...
![设置菜单](docs/images/agent-qt-settings.png)

### 技能列表

![技能列表](docs/images/agent-qt-skills.png)

### 定时计划

![定时计划](docs/images/agent-qt-schedules.png)
...
└── docs/
    └── images/
        ...
        ├── agent-qt-settings.png
        ├── agent-qt-skills.png
        ├── agent-qt-schedules.png
